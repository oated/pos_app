...
class BookingStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create booking_status" do
    assert_difference("BookingStatus.count") do
      post booking_statuses_url, params: { booking_status: { name: @booking_status.name } }, as: :json
    end
  ...
  test "should update booking_status" do
    patch booking_status_url(@booking_status), params: { booking_status: { name: @booking_status.name } }, as: :json
    assert_response :success
  end
